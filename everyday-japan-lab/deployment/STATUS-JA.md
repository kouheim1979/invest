...
- サイト表記はEveryday Japan Labに統一。再開前にブランド用の連絡方法を設ける。GitHubの所有者URLや過去の履歴はこの修正では匿名化されない。
...
- Contactは現在、窓口準備中で問い合わせを受け付けない。再開前にブランド用の連絡方法を用意し、Privacyを合わせて更新する。
...
4. 当時のContactは個人アカウントにつながる窓口を使用していたが、2026-09-25に撤去済み。再開前にブランド用の連絡方法を決める。アカウントのメールアドレスを自動転記しない。
