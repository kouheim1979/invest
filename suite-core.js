...
'use strict';
const routes={home:[],assets:['overview','purposes','holdings','owners'],holdings:[],dividends:['history','broker','receipts','csv','forecast'],settings:['menu','import','storage','consult']};
