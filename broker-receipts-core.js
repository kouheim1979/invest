...
function merge(old,incoming){
 ...
 return validate({...p,preparedAt:a.preparedAt>p.preparedAt?a.preparedAt:p.preparedAt,scopeNote:notes,...(a.accounts||p.accounts?{accounts:[...new Set([...(a.accounts||[]),...(p.accounts||[])])]}:{}),documents:[...docs.values()],receipts:[...rows.values()]});
}
