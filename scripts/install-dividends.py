...
marker = '<script src="./dividends-entry.js?v=20260916-sheet1"></script>'
if old_markers[0] in s:
    s = s.replace(old_markers[0], marker)
...
print('Dividend sheet navigation installed; existing portfolio data and code unchanged')
