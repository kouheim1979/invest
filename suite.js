...
const sources={assets:'mf-assets/index.html?suite=1&v=20260920-1',holdings:'app-v3.html?suite=1',dividends:'dividends-dashboard.html?suite=1',receipts:'dividends.html?mode=receipts&suite=1'};
