...
const sources={broker:'broker-receipts.html?suite=1&v=20260920-2',assets:'mf-assets/index.html?suite=1&v=20260920-3',holdings:'app-v3.html?suite=1',dividends:'dividends-dashboard.html?suite=1',receipts:'dividends.html?mode=receipts&suite=1'};
